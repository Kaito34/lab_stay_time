...
from src.models.yolov5.detect import main as detect_main
...
predicted_name = detect_main(opt)
true_name = Ask_name().main(predicted_name)
put_data(datetime.datetime.today(), predicted_name)

now = datetime.datetime.now()
# スコアを受け取る
score = get_data(now, true_name)
